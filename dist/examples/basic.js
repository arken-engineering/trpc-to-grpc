...
exports.appRouter = packageMiddleware_1.t.router({
    ...
    send: packageMiddleware_1.t.procedure
        .use((0, packageMiddleware_1.packageMiddleware)({ packages: ['twirp.internal.twirp', 'test.multiple'], options: { go_package: '/multiple' } }))
        .input(Msg1Schema)
        .output(Msg1Schema)
        .mutation(() => {
        return {};
    ...
    execute: packageMiddleware_1.t.procedure
        .use((0, packageMiddleware_1.packageMiddleware)({ packages: ['network.protocol.storage'], options: { cc_generic_services: 'true' } }))
        .input(zod_1.z.object({
        schema: zod_1.z.string().optional(),
        privilege: zod_1.z.object({
